...
const HomeHero = ({ pokemos }) => {
  return (
    ...
    >
      {pokemos.map((item) => {
        const { firstName, lastName, imageUrl } = element.attributes;
        return (
          <SwiperSlide
            key={item.id}
            tag='section'
            ...
            style={{
              ...
              backgroundImage: `url(${imageUrl.data[0].attributes.url})`
            }}
          >
            <div className="container container--hero">
              <div className="card card--hero">
                <div className="card__body card__body--hero">
                  ...
                  <h3 className="card__subtitle card__subtitle--hero">{lastName.data[0].attributes.firstName} </h3>
